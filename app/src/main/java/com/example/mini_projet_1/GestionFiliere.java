        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (var1 == null || var1.equals("") || var1.length() == 0 || var2.equals("") || var2.length() == 0){
                    Toast.makeText(getBaseContext(),"Please Fill Fields", Toast.LENGTH_LONG).show();
                }else if (verifyExistance(filieresList,var2)){
                    mydb.addModule(var1);
                    Toast.makeText(getBaseContext(),"Added module to existing filiere", Toast.LENGTH_LONG).show();
                }else{
                    mydb.addModule(var1);
