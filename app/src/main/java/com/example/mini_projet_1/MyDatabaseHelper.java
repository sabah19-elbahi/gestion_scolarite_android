...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    void addModule(String module_name){
        ...
        if (result == -1){
            Toast.makeText(context, "Échec de l'insertion du Module", Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(context, "Module inséré avec succès", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    void addFiliere(String filiere_name){
        ...
        if (result == -1){
            Toast.makeText(context, "Échec de l'insertion de Filière et du Module", Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(context, "Filière et Module insérés avec succès", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    void addStudent(String student_cne, String student_name, String student_last_name, String student_filiere_name){
        ...
        if (result == -1){
            Toast.makeText(context, "Échec de l'insertion de l'Étudiant", Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(context, "Étudiant inséré avec succès", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    void addNote(String student_cne, String module_name, String student_note){
        ...
        if (result == -1){
            Toast.makeText(context, "Échec de l'insertion de la Note", Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(context, "Note insérée avec succès", Toast.LENGTH_SHORT).show();
        }
    }
